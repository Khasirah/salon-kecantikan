...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['service'] = $this->ModelService->getLimitservice()->result_array();
        //mengupdate stok dan dibooking pada tabel service
        ...
        foreach ($detail as $key) {
            ...
            if ($beda->days > 2) {
                $this->db->query("UPDATE service SET stok=stok+1, dibooking=dibooking-1 WHERE id='$id_service'");
            }
        }
