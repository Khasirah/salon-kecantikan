			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_perpus->get_data('service')->num_rows(); ?></b></font>
						</div>
						<div><b>Jumlah service yang Terdaftar</b></div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		<div class="col-lg-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size: 18px; font-weight: bold;"><i class="glyphicon glyphicon-random arrow-right"></i> service</h3>
				</div>
				<div class="panel-body">
					<div class="list-group">
						<?php foreach($service as $b){ ?>
							<a href="#" class="list-group-item">
								<span class="badge"><?php if($b->status_service == 1){echo "Tersedia";}else{echo "Dipinjam";}?></span>
								<i class="glyphicon glyphiconuser"></i> <?php echo $b->judul_service; ?>
							</a>
						<?php } ?>
					</div>
					<div class="text-right">
						<a href="<?php echo base_url().'admin/service' ?>">Lihat Semua service <i class="glyphicon glyphicon-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
