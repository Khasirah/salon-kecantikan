    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php foreach ($service as $b) { ?>
                <form action="<?= base_url('service/ubahservice'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" name="id" id="id" value="<?php echo $b['id']; ?>">
                        <input type="text" class="form-control form-control-user" id="judul_service" name="judul_service" placeholder="Masukkan Judul service" value="<?= $b['judul_service']; ?>">
                    </div>
                    <div class="form-group">
